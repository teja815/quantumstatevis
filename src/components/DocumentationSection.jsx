      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className={`text-4xl md:text-5xl font-bold mb-6 ${
            ...
            Documentation & <span className="bg-gradient-to-r from-purple-600 to-cyan-600 bg-clip-text text-transparent">
              Resources
            </span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {docs.map((doc, index) => (
            <motion.div
              ...
              className={`group cursor-pointer p-6 rounded-2xl backdrop-blur-md border transition-all duration-300 ${
                darkMode
            ...
            >
              {/* Glow effect */}
              <div className={`absolute inset-0 rounded-2xl bg-gradient-to-r ${doc.color} opacity-0 group-hover:opacity-10 transition-opacity duration-300`} />
              
              {/* Icon */}
              <div className={`w-12 h-12 rounded-xl bg-gradient-to-r ${doc.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>
