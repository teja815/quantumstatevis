...
import { Mail, Lock, Eye, EyeOff, Moon, Sun, User, ArrowRight } from "lucide-react";
          ...
          <div className="px-8 pb-8">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <motion.button
                  type="submit"
                  className="w-full group relative px-6 py-3 bg-gradient-to-r from-purple-600 to-cyan-600 text-white rounded-xl font-semibold overflow-hidden"
                ...
                <motion.button
                  ...
                  className={`w-full flex items-center justify-center space-x-3 px-6 py-3 rounded-xl border-2 font-semibold transition-all duration-200 hover:scale-102 ${
                    darkMode
                      ? 'border-gray-600 text-gray-300 hover:border-purple-500 hover:text-white hover:bg-gray-800/50'
                      : 'border-gray-300 text-gray-700 hover:border-purple-500 hover:text-purple-600 hover:bg-white/70'
                  }`}
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
